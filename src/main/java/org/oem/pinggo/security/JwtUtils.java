...
public class JwtUtils {
    ...
    @Value("${bookz.app.jwtSecret}")
    private String jwtSecret;

    @Value("${bookz.app.jwtExpirationMs}")
    private int jwtExpirationMs;

    @Value("${bookz.app.jwtCookieName}")
    ...
    public ResponseCookie generateJwtCookie(UserDetailsDTO userPrincipal) {
        ...
        final ResponseCookie cookie = ResponseCookie.from(jwtCookie, jwt).path("/api").maxAge(24 * 60 * 60).httpOnly(true).build();
        return cookie;
    }
